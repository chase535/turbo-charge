...
int main()
{
    ...
    char **ppp,done[100],asdf[310],charge[100],uevent[3010],power[100],current_max[100],highest_temp_current[100],buffer[3010],constants[3010],msg[110],thermal[310],temps[3010],option[1010];
    int *file_num,done_int,asdf_int,wasd=0,charge_start,charge_stop,temp_ctrl,power_ctrl,power_int,recharge_temp,current_max_int,temp_max,highest_temp_current_int,temp_int,qwer;
