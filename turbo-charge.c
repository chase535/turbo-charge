...
int main()
{
    ...
    char temp_sensors[13][15]={"lcd_therm","quiet_therm","modem_therm","wifi_therm","mtktsbtsnrpa","mtktsbtsmdpa","mtktsAP","modem-0-usr","modem-1-usr","modem1_wifi","conn_therm","ddr-usr","cwlan-usr"};
